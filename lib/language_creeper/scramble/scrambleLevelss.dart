...
class ScrambleLevels extends StatefulWidget {
  const ScrambleLevels({Key? key}) : super(key: key);

  @override
  _CodexLevelsState createState() => _CodexLevelsState();
}

class _CodexLevelsState extends State<ScrambleLevels> {
  int? selectedLevel;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Select Scramble Level'),
      ),
